...
//Helper function for getting language from headers
...
/**
 * Password reset controller - sending reset link
 */
...
/**
 * Controller for setting a new password
 */
...
/**
 * Controller for checking the validity of a reset token
 */
...
/**
 * Controller for changing the email address
 */
export const changeEmail = async (
  ...
  try {
    ...
    //Send a confirmation email to your old address
    const text = `
